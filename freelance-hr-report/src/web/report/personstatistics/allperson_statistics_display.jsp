...
<body>
  <h3 style="height: 30px; padding: 5px 0;"><a class="btn-search btn-default" href="javascript:void(0)" class="popdown btn1" onclick="location.href='goViewEveryOfficeSummaryInfo.do?method=goviewEveryOfficeSummaryInfo&exportExcel=true';">导出</a></h3>
