...
<body>
<form id="dicItemForm" class="form-inline" action="updateDicItem.do?method=updateDicItem" method="post" onsubmit="return false">
  <div id="transaction_modal_box" class="transaction_modal_box">
    <div class="modal-dialog-container">
      <div class="md-title">数据字典 &gt;修改<a href="#" class="md-close close-popdown" button-click="widget-close"></a></div>
          ...
          <dl>
            ...
            <dd>
              <label><input type="text" name="dicItemCode"
                class="modal_iput" maxlength="20" value="${dicItemForm.dicItemCode}"/>
              </label>
            </dd>
          </dl>
          <dl>
            ...
            <dd>
              <label><input type="text" name="dicItemName"
                class="modal_iput" maxlength="100" value="${dicItemForm.dicItemName}"/>
              </label>
            </dd>
          </dl>
          <dl>
            ...
            <dd>
              <label> <input type="text" name="displayOrder"
                class="modal_iput" maxlength="8" value="${dicItemForm.displayOrder}"/> </label>
            </dd>
          </dl>
          <dl class="updown-remark">
            <dt>备注：</dt>
            <dd style="width: 83%;">
              <label><textarea rows="3" name="remark" maxlength="500">${dicItemForm.remark}</textarea>
              </label>
            </dd>
          </dl>
          <div class="clear"></div>
