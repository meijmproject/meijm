	        ...
	        <div class="modal-row02">
		        ...
		        <dl>
		             ...
		             <dd>
						<html:select styleId="parentOrgOid" styleClass="modal_iput" property="parentOrgOid" >
							...
							<c:if test="${!empty parentOrgName }">
								<option value="${verUbOrgInfoForm.parentOrgOid }" selected>${parentOrgName }</option>
							</c:if>
				...
				<dl>
		             ...
		             <dd><html:select styleId="orgStatus" styleClass="modal_iput" property="orgStatus" >
		             		<c:choose>
		             			<c:when test="${verUbOrgInfoForm.orgStatus == '1' }">
		             		...
		             		<c:choose>
		             			...
		             			<c:when test="${verUbOrgInfoForm.orgStatus == '2' }">
		             		...
		             		<c:choose>
		             			<c:when test="${verUbOrgInfoForm.orgStatus == '3' }">
		             				<option value="3" selected>撤销</option>
		             			</c:when>
		             			<c:otherwise>
