...
{
	//$(".right-content").load("goToPersonGoOutManagePage.do?method=goTopersonWorkBench&orgOid="+orgOid);
}
function workUnitLocation(unitOid)
{
	$(".right-content").load("goToUnitManger.do?method=goToUnitManger&unitOid="+unitOid);
}
</script>
</body>
</html>