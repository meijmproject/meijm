...
<div id="transaction_modal_box" class="big-madal-dialog transaction_modal_box">
    ...
    <div class="modal-dialog-container">
        ...
        <div class="md-main-content">
            <table class="institution_basic show-more-info">
        ...
        <div class="md-btn">
            <button class="md-btn-save close-popdown" id="saveGBPlanForm">保存</button>
        </div>
    </div>
</div>
</form>
...
function fingure() {
	...
	$('#transaction_modal_box #YHRS0022_2_YHRS0023_A10200100100').html(YHRS0022_2_YHRS0023_A10200100100);
	...
	$('#transaction_modal_box #YHRS0022_2_YHRS0023_A10200100200').html(YHRS0022_2_YHRS0023_A10200100200);
	...
	$('#transaction_modal_box #YHRS0022_2_YHRS0023_A10200100300').html(YHRS0022_2_YHRS0023_A10200100300);
	...
	$('#transaction_modal_box #YHRS0022_2_YHRS0023_A10200100400').html(YHRS0022_2_YHRS0023_A10200100400);
	...
	$('#transaction_modal_box #YHRS0022_1').html(YHRS0022_1);
	$('#transaction_modal_box #YHRS0022_2').html(YHRS0022_2);
	$('#transaction_modal_box #YHRS0022_3').html(YHRS0022_3);
	
	var all = Number($('#transaction_modal_box #YHRS0022_1').html())
	+Number($('#transaction_modal_box #YHRS0022_2').html())
	+Number($('#transaction_modal_box #YHRS0022_3').html());
	$('#transaction_modal_box #all').html(all);
...
$('#saveGBPlanForm').click(function() {
	...
	$.ajax({
	    url:'updateGBPlan.do?method=updateGBPlan',
	    type:'POST',
	    data: data,
	    dataType:'json',
