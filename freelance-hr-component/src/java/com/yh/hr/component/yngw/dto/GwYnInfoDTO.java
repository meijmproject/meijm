package com.yh.hr.component.yngw.dto;

public class GwYnInfoDTO {
	...
	private java.lang.String haveBranchPositionName;//是否含有子类
	
	
	public java.lang.String getHaveBranchPositionName() {
		return haveBranchPositionName;
	}
	public void setHaveBranchPositionName(java.lang.String haveBranchPositionName) {
		this.haveBranchPositionName = haveBranchPositionName;
	}
