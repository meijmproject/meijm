package com.yh.hr.component.im.check.service.dic.impl;
 ...
 * @version 1.0
 */
public class DictionaryCheckServiceImpl implements DictionaryCheckService {
	...
	private void deleteUnusualLogs(Long importBatchOid, String databaseColumnCode) throws ServiceException {
		String delSql = "DELETE FROM yhc_im_check_person_unusual WHERE CHECK_TYPE = '4' AND DATABASE_COLUMN_CODE = '"+databaseColumnCode+"' AND IMPORT_BATCH_OID = "+ importBatchOid;
	...
	private void insertUnusualLogs(Long importBatchOid, String databaseColumnCode, String templateCollName) throws ServiceException {
		String message = templateCollName+"没有字典映射";
