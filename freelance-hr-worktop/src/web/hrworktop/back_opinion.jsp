...
<!--
 * @function    录入退回意见页面
 * @page name   /freelance-hr-worktop/src/web/hrworktop/back_opinion.jsp
 * @author      wangx
 * @created     2017-05-17
 * @version     1.0
-->
	...
	$(".agree_opinion_submit").click(function(){
	    ...
	    $("#formAgreeOpinion").validate({
	        ...
	        submitHandler: function (form)
	        {
	    		...
	    		//alert(taskOid);
				Mask.showMask();
	    		$.post("bizDefaultRecheckBack.do?method=submitRecheckBack&itemCodes="+itemCodes+"&itemNodeCodes="+itemNodeCodes+"&opinion="+opinion+"&bizTaskOids="+bizTaskOids+"&applyNames="+applyNames,function(data){
					Mask.hideMask();
	       			if (data.success) {
	       				Widget.close();
