...
<!--
 * @function    录入审核意见页面
 * @page name  /freelance-hr-worktop/src/web/hrworktop/back_opinion_unit.jsp
 * @author      zhengdr
 * @created     2016年12月22日10:14:49
 * @version     1.0
-->
<!DOCTYPE html>
<html>
	...
	$(".agree_opinion_submit").click(function(){
	    ...
	    $("#formAgreeOpinion").validate({
	        ...
	        submitHandler: function (form)
	        {
	    		...
	    		//alert(taskOid);
				Mask.showMask();
	    		$.post("bizDefaultRecheckBack.do?method=submitRecheckBack&itemCodes="+itemCodes+"&itemNodeCodes="+itemNodeCodes+"&opinion="+opinion+"&bizTaskOids="+taskOid+"&applyNames="+applyNames,function(data){
					Mask.hideMask();
	       			if (data.success) {
	       				Widget.close();
