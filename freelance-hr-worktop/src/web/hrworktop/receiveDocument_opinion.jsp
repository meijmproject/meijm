...
<!--
 * @function    录入审核意见页面
 * @page name   /freelance-hr-biz/src/web/hrbiz/official/offinfromoutapprove/agree_opinion.jsp
 * @author      xiongyx
 * @created     2016/10/18
 * @version     1.0
-->
    ...
    <div>
       ...
       <p class="agree_opinion_fontTop">本次业务涉及以下人员：</p>
        ...
        <div class="agree_opinion_inputfont">
            <textarea id="opinion" name="content" class="z_text_id" maxlength="200" rows="13" cols="125%;" placeholder="请输入办理意见；(字数不能超过200字)">已接收材料</textarea>
        </div>
