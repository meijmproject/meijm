...
<!--
 * @function    录入审批意见页面
 * @page name   /freelance-hr-worktop/src/web/hrworktop/agree_opinion_select.jsp
 * @author      wangx
 * @created     2017-05-17
 * @version     1.0
-->
	...
	$(".agree_opinion_submit").click(function(){
	    ...
	    $("#formAgreeOpinion").validate({
	        ...
	        submitHandler: function (form)
	        {
				...
				Mask.showMask();
	    		$.post("bizDefaultRecheckAgree.do?method=submitRecheckAgree&itemCodes="+itemCodes+"&itemNodeCodes="+itemNodeCodes+"&approveLeader="+leader+"&approveDate="+date+"&opinion="+opinion+"&bizTaskOids="+bizTaskOids+"&applyNames="+applyNames+"&defFlowExpress="+defFlowExpress,function(data){
					Mask.hideMask();
	       			if (data.success) {
	       				Widget.close();
