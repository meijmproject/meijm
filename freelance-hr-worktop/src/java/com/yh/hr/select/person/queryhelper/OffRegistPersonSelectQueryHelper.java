...
public class OffRegistPersonSelectQueryHelper {
	...
	public static List<PersonSelectDTO> listPbpersonInfo(TableTagBean ttb) throws ServiceException {
		...
		hql.append(" and (jppi.is_enrol is null or jppi.is_enrol = '").append(DicConstants.YHRS0018_2).append("')");//已登记的公务员不显示
		hql.append(" and jppa.ADMINISTRATIVE_DUTY is not null  ");
