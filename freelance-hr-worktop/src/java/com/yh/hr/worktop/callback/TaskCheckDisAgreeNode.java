 ...
 * @created 2016-8-30
 */
public class TaskCheckDisAgreeNode implements FlowCallBackInterface {

   /* private PersonService personService = (PersonService) SpringBeanUtil.getBean("personService");
    private PartyPositionService partyPositionService = (PartyPositionService) SpringBeanUtil.getBean("partyPositionService");
*/
    /**
     * 环节前置数据校验。
...
//	 		更新办理同意
			bo.setProcessResult(TaskConstants.PROCESS_RESULT_1);
	    	 //更新完成时间
		...
		{
			throw new JadeWorkFlowException("doAfter processId fail","环节后置处理失败！");
		}
    }
}
