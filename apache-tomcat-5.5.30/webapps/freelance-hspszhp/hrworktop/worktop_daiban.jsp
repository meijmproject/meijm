	...
	worktop = new Worktop([
		{
			...
			xname: 'form',//属性名 worktop.form = new WorkBenchForm();
		...
		},
		{
			...
			xtype:'WorkBenchGrid',
			xname:'grid',
			url: 'listJhcBtTaskItem.do?method=listJhcBtTaskItem&taskItemCode=${itemNodeCode}&menuCode=${menuCode}&taskItemStatus=1',
			dbflag: '${param.dbflag}'
		},
		{
			wrap: '#bizViewportFrameId',
