...
<!--
 * @function    录入审批意见页面
 * @page name   /freelance-hr-worktop/src/web/hrworktop/check_opinion.jsp
 * @author      wangx
 * @created     2017-05-17
 * @version     1.0
-->
	...
	$(".agree_opinion_submit").click(function(){
	    ...
	    $("#formAgreeOpinion").validate({
	        ...
	        submitHandler: function (form)
	        {
				...
				Mask.showMask();
	    		$.post("bizDefaultRecheckAgree.do?method=submitRecheckAgree&itemCodes="+itemCodes+"&itemNodeCodes="+itemNodeCodes+"&opinion="+opinion+"&bizTaskOids="+bizTaskOids+"&applyNames="+applyNames,function(data){
					Mask.hideMask();
	       			if (data.success) {
	       				Widget.close();
    ...
    <div>
       ...
       <%-- <p class="agree_opinion_fontTop">本次业务涉及以下人员：</p>
        ...
        <p class="agree_opinion_alert">
            <span class="agree_opinion_alertfont" style="color: red;">提交后该业务将结束审批流程，请确认不需要后续审批环节再提交！</span>
        </p>
