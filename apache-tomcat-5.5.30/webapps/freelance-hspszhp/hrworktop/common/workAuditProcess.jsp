		...
		<div class="modal-dialog-container">
			...
			<div class="md-main-content">
						...
						<table class="sr-table">
							<thead class="sr-table-thead">
								<tr>
									...
									<th style="width:20%!important">时间</th>
									<th style="width:15%!important">业务状态</th>
									<th style="width:15%!important">处理人</th>
									<th style="width:15%!important">办理部门</th>
									<th style="width:15%!important">处理意见</th>
								</tr>
							</thead>
                  ...
                  <c:if test="${stat.last}">
                     <td style="width:5%!important">
                        <ul class="bus_flow_path">
                            <li class="bus_flow_finish">
                                <img src="img/business/check_transaction/under-report.png"  class="under-report" alt=""/>
                            </li>
                        </ul>
                    </td>
                   </c:if>  
                ...
                <c:if test="${stat.first}">
                    <td style="width:5%!important">
                        <ul class="bus_flow_path">
                            <li class="bus_flow_span">
                            <img src="img/business/check_transaction/bus_finish.png"  class="bus_finish" alt=""/>
                            </li>
                        </ul>
                    </td>
                   </c:if>  
                    <c:if test="${!stat.first and !stat.last}">
                    <td style="width:5%!important">
                        <ul class="bus_flow_path">
                            <li class="bus_flow_span_full">
                            <img src="img/business/check_transaction/bus_finish.png"  class="bus_termination" alt=""/>
                            </li>
                        </ul>
                    </td>
                   </c:if>  
                        ...
                        <ul class="bus_flow_path">
                            <li class="bus_flow_finish">
                                <img src="img/business/check_transaction/under-report.png"  class="under-report" alt=""/>
										...
										<td style="width:15%!important">${BtLogDTO.auditStatusName}</td>
...
<%-- <div id="showmodal" class="modal-content">
	 ...
	 <div class="modal-header">
        ...
        <h4 class="modal-title">查看业务信息&gt;查看审批记录</h4>
    </div>
	<div class="modal-body">
	  <div style="height:400px">
        <table class="transaction_modal_table2">
            <tr class="transaction_modal_table_title" style="border-bottom: 1px solid #ddd;">
                <td width="5%"></td>
            ...
            <c:forEach items="${list}"  var="BtLogDTO" varStatus="stat" >
                ...
                <c:if test="${stat.first}">
                   ...
                   <c:if test="${stat.last}">
                    ...
                    <td style="width:20%!important"><bean:write name="BtLogDTO" property="createdDate" format="yyyy-MM-dd HH:mm:ss"/></td>
                    <td style="width:15%!important">${BtLogDTO.auditStatusName}</td>
                    <td style="width:15%!important">${BtLogDTO.createdByName}</td>
                    <td style="width:15%!important">${BtLogDTO.processDeptName}</td>
                </tr>
