...
$(function(){
   ...
   /* 小屏幕的操作
    ...
    /*//缩放函数，obj标识缩放的对象，aim_width为缩放后的宽度，speed代表速率，如为10，者代表每20毫秒缩放10像素
    function div_width_scale(obj,aim_width,speed){
        var widths = parseInt(obj.css('width'));
        var width_d = aim_width-widths;
        var times = Math.ceil(width_d/speed);
        var x=0;
