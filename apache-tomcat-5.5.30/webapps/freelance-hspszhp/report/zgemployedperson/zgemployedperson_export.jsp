...
<%
	response.setHeader("Content-Disposition", "attachment; filename="+new String(("在岗人员总表.xls").getBytes("GBK"), "ISO8859-1"));
%>
<!DOCTYPE html>
<html>
<head>
...
<body>
	<table class="institution_basic" id="zgemplyedperson_collection_table_html" border=1>
