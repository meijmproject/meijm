...
<html>
<%
	response.setHeader("Content-Disposition", "attachment; filename="+new String(("培训情况统计报表.xls").getBytes("GBK"), "ISO8859-1"));
%>
<head>
    <meta charset="UTF-8">
...
<body>
	<!-- <div class="handel"><button class="btn_print" onclick="location.href='dpos-hspszhp/goviewTrainSituationPersonInfo.do?method=goviewTrainSituationPersonInfo&flag=excel';">导出</button></div> -->
	<table id="wardset_collection_table_html" cellspadding="0" cellspacing="0" align="center" >
		<thead>
			<tr><th id="wardset_collection_title" colspan="16" >培训情况报表</th></tr>
		</thead>
