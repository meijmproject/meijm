...
<!--
 * @function    人员信息管理减员 - 离职页面
 * @page name   /hrinfo/management/unit/person/reduce_person_out.jsp
 * @author      duxw
 * @created     2017/03/23
 * @version     1.0
-->
...
<title>人员信息管理-离职页面</title>
<script type="text/javascript" src="hrinfo/management/unit/person/js/check_reduce_person_out.js"></script>
<script type="text/javascript" src="js/comm/customJs.js"></script>
<script type="text/javascript" src="js/comm/common_validator.js"></script>
</head>
<body>
	<form id="pbPersonOutForm" class="form-inline" action="createPersonOut.do?method=createPersonOut" method="post" onsubmit="return false">
		<div id="transaction_modal_box" class="transaction_modal_box">
			<div class="modal-dialog-container">
				<div class="md-title">
					人员信息管理&gt;离职<a href="#" class="md-close close-popdown" button-click="widget-close"></a>
				</div>
				...
				<div class="md-main-content">
					...
					<div class="infoshow-container md-infoshow-area">
						...
						<div class="infoshow-container">
							<div class="isc-title-box">
								<h3 class="md-isc-title">人员离开信息</h3>
							</div>
							<div class="md-infoshow-content">
							<jsp:include page="/hrinfo/ver/unit/comm/pbpersonout/pbPersonOutShow.jsp"></jsp:include>
						</div>
						</div>
					</div>
