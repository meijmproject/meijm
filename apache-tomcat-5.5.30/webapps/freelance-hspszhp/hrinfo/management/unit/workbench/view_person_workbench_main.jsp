...
function expandNode(){
	$.ajax({
		...
		success : function(data) {
		    ...
		    //默认显示右侧工作台  
			$(".right-content").load("goToPersonViewPage.do?method=goToPersonWorkBench&functionCode=personManage");
		}
	});
}
...
{
	$(".right-content").load("goToPersonViewPage.do?method=goToPersonWorkBench&orgOid="+orgOid+"&functionCode=personManage");
}
function workUnitLocation(organizationOid)
{
	$(".right-content").load("goToPersonViewPage?method=goToPersonWorkBench&organizationOid="+organizationOid+"&functionCode=personManage");
}
</script>
</body>
</html>