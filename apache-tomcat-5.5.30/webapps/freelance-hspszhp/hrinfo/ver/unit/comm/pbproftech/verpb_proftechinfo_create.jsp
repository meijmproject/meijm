...
<body>
	<div id="showmodal" class="modal-content">
			<form id="formVerProfTech" action="addVerProfTechInfo.do?method=add"
				...
				<div class="modal-header">
					...
					<h4 class="modal-title">专业技术资格信息&gt;新增</h4>
				</div>
		<div class="modal-body">
            ...
            <ol class="wroglist">
               <logic:messagesPresent>
				...
				<input type="hidden" id="profTechPersonOid" name="personOid"
					value="${verProfTechInfoForm.personOid}"> <input
					type="hidden" id="profTechId" value="${id}">
					...
					<dl>
						...
						<dd>
							<input type="text" name="profTechNameId" id="profTechName"
								...
								readonly="readonly" /> <input type="hidden" name="profTechName">
						...
						<dd>
							<dictionary:dicItemSelect style="width:180;" id="profTechLevel"
								name="profTechLevel"
				...
				<div class="modal-row03">
					<dl>
						...
						<dd>
							<input type="text" id="profTech_procureDateStr"
								name="procureDateStr"
...
<%-- 						<dt title="有效期">有效期：</dt>
						<dd>
							<input type="text" id="profTech_validityDateStr"
						...
						<dd>
							<dictionary:dicItemSelect style="width:180;"
								id="profTech_acquireApproachCode" name="acquireApproachCode"
				...
				<div class="modal-row03">
					<dl>
						...
						<dd>
							<input type="text" id="profTech_acquireApproachOther"
				...
				<dt title="资格审批机构名称">资格审批机构名称：</dt>
							<dd>
								<input type="text" id="approveOrganName" name="approveOrganName"
