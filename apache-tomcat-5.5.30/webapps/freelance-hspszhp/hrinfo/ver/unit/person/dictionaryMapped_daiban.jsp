...
<div class="person-map-table-tbody">
 <table class="sr-table">
        ...
        <tr>
            ...
            <td><dictionary:dicItemSelect id="${databaseColumnCode}" dicTypeCode="${dicTypeCode}" name="${databaseColumnCode}" /></td>
        </tr>
       </c:forEach>
        </tbody>
    </table>
    ...
    <c:if test='${not empty  list}'>
     <div class="person-map-table-btn clearfix"><button class="btn-search btn-default" id='save'>保存</button></div>
     </c:if>
</BODY>
