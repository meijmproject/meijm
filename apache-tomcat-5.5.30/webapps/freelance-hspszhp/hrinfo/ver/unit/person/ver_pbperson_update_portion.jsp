...
<script src="hrinfo/ver/unit/person/js/VerPbPersonOperatePortion.js"></script>
	...
	<html:form styleId="formPersonUpdate" styleClass="form-inline" action="updateVerPersonInfo.do?method=updateVerPersonInfo" enctype="multipart/form-data" method="post" onsubmit="return false">
		<div id="transaction_modal_box" class="transaction_modal_box">
			<div class="modal-dialog-container">
				<div class="md-title">
					个人信息修改 &gt;修改<a href="#" class="md-close close-popdown"></a>
				</div>
				...
				<div class="md-main-content">
					...
					<jsp:include page="/hrinfo/ver/unit/person/ver_pbperson_body_portion.jsp"></jsp:include>
