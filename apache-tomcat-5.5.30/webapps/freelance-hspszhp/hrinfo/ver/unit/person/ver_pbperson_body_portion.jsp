	...
	<div class="md-infoshow-content">
		<div class="md-units md-three-column md-unit-hasimg clearfix">
			...
			<dl class="updown-dl">
				...
				<dd>
					<label> <input type="text" readonly id="name" name="name" value="${verPbPersonInfoForm.name }" maxlength="50" /> </label>
				</dd>
			</dl>
			<dl class="updown-dl">
				<dt>
			...
			<dl class="updown-dl">
				...
				<dd>
					<label> <input type="text" readonly id="personCode" name="personCode" value="${verPbPersonInfoForm.personCode }" maxlength="20" /> </label>
				</dd>
			</dl>
			<dl class="updown-dl">
				...
				<dd>
					<label> 
					<input type="text" readonly class="modal_iput" name="hireDeptName" id="hireDeptOid" value='${verPbPersonInfoForm.hireDeptName}' " /> 
			...
			<dl class="updown-dl">
				...
				<dd>
					<label> 
					<input type="text" readonly  value='<dictionary:viewDicItemName dicTypeCode="<%=DicConstants.YHRS0009%>" dicItemCode="${verPbPersonInfoForm.personStatus}" />'  />
						
						<input type="hidden" name="personStatus" value="${verPbPersonInfoForm.personStatus}" />
					</label>
				</dd>
			</dl>
			<dl class="updown-dl">
				...
				<dd>
					<label>
					<input type="text" readonly  value='<dictionary:viewDicItemName dicTypeCode="<%=DicConstants.YHRS0010%>" dicItemCode="${verPbPersonInfoForm.personType}" />'  />
			...
			<dl class="updown-dl">
				...
				<dd>
					<label> <input type="text" name="idName" id="idCode" value='<dictionary:viewDicItemName dicTypeCode="<%=DicConstants.YHRS0002%>" dicItemCode="${verPbPersonInfoForm.idCode}" />' onclick="min_Dic.min_Dictionary(this,'<%=DicConstants.YHRS0002%>')" /> <a class="md-unit-clear" onclick="$(this).siblings('input').val('')"></a></label> <input type="hidden" name="idCode" value="${verPbPersonInfoForm.idCode}" />
				</dd>
			</dl>
			<dl class="updown-dl">
				<dt>
			...
			<dl class="updown-dl">
				...
				<dd>
					<label> <html:text styleId="birthdayStrUpdate" property="birthdayStr" onchange="numAge(this)" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd'});" /> </label>
				</dd>
			</dl>
			<dl class="updown-dl">
				<dt>
		...
		<%-- 	<dl class="updown-dl">
			...
			<dl class="updown-dl">
				<dt>
					<b class="Required">* </b>紧急联系人手机号码：
				</dt>
				<dd>
					<label> <input type="text"  id="emergPhone" name="emergPhone" value="${verPbPersonInfoForm.emergPhone }" maxlength="50" /> </label>
				</dd>
			</dl>
