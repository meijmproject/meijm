...
<form id="systemPositionForm"  Class="form-inline" action="addSystemPoistion.do?method=addSystemPoistion" method="post">
    <div class="modal-header">
       <button type="button" class="close close-popdown" data-dismiss="modal" aria-label="Close" button-click="widget-close">
					<span aria-hidden="true">&times;</span>
				</button>
         <h4 class="modal-title">系统岗位信息&gt;新增</h4>
    </div>
			...
			<div class="modal-row01">   
				 <dl>
					 <dt><b class="Required">*</b>系统岗位名称：</dt>
                        <dd><input name="systemPositionName" type="text" class="modal_iput" required  maxlength="100"/></dd>
					<dt><b class="Required">*</b>系统岗位描述：</dt>
						<dd><input name="systemPositionDesc" type="text" class="modal_iput" required maxlength="1000"/></dd>
               	</dl>
           </div>
	  </div>
			...
			$(form).ajaxSubmit({
				success: function(data){
					...
					if(data.success){
						...
						var goBackUrl="goSystemPoistionList.do?method=goSystemPoistionList";
						window.location.href="goUpdateSystemPoistion.do?method=goViewSystemPoistion&systemPositionOid="+data.message+"&goBackUrl="+goBackUrl;
					}else{
