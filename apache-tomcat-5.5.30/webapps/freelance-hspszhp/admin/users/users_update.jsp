...
<body>
<!--左导航-->
    <div class="sys_base">用户信息:<a  href="javascript:void(0);" onclick="updateUserInfo(${usersForm.userOid})" style="float:right;margin-left: 20px;">
