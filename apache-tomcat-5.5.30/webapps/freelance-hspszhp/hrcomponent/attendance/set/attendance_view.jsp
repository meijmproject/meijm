	...
	<form id="formAttendanceUpdate" class="form-inline" action="updateAttendance.do?method=updateAttendance" method="post" onsubmit="return false">
		...
		<div id="transaction_modal_box" class="transaction_modal_box">
			<div class="modal-dialog-container">
				<div class="md-title">
					考勤参数设置管理 &gt;查看<a href="#" class="md-close close-popdown" button-click="widget-close"></a>
				</div>
		...
		<div class="md-units-adddata md-units md-three-column clearfix">
			<dl class="updown-dl">
	            ...
	            <dd>
	              <label>
	              <input id="startDateStr" name="startDateStr" value="${attendanceForm.attendanceYear}" class="modal_iput" readonly="readonly"/>
	          ...
	          <dl class="updown-dl">
	            ...
	            <dd>
	              <label>
	              <input id="startDateStr" name="startDateStr" value="${attendanceForm.attendancePeriod}" class="modal_iput" readonly="readonly"/>
	          ...
	          <dl class="updown-dl">
	            <dt>非出勤天数：</dt>
	            <dd>
	              <label><input type="text" id="noAttendanceDays" name="noAttendanceDays" value="${attendanceForm.noAttendanceDays}"readonly="readonly"  class="modal_iput" />
	              </label>
	            </dd>
	          </dl>
	          <dl class="updown-dl">
	          ...
	          <dl class="updown-remark">
	            ...
	            <dd>
	              <label>
	              		 <input type="text" id="noAttendanceDateStr" name="noAttendanceDateStr" value="${attendanceForm.noAttendanceDateStr}" class="modal_iput" title="${attendanceForm.noAttendanceDateStr}" readonly="readonly"/>	
	              </label>
	            </dd>
	          </dl>
	           <dl class="updown-remark">
                           <dt>备注：</dt>
                           <dd><textarea id="remark" name="remark" readonly="readonly" maxlength="1000">${attendanceForm.remark}</textarea></dd>
               </dl>
          </div>
           </div>
				</div>
