...
<script type="text/javascript">
	...
	$(document).ready(function() {
		...
		worktop = new Worktop([
          ...
          buttons: {
        	  'add': function() {
                  Widget.openContent('goCreateOrg.do?method=goCreateOrg&unitOid='+ unitOid);
              },
              'revoke': function() {
 ...
 <div class="search-content">
		<div class="search-include mrb-40 clearfix">
			<form id="fr_wsid" action="#" method="post">
				<dl class='search-unit' >
					<dt class="search-unit-dt">科室名称：</dt>
					<dd class="search-unit-dd">
						<label>
							<input type="text" name="deptName" id="deptName" maxlength="100"/>
						</label>
					</dd>
				</dl>
				<dl class='search-unit' >
					<dt class="search-unit-dt">科室类型：</dt>
					<dd class="search-unit-dd">
						<label>
							<dictionary:dicItemSelect id="deptType"  name="deptType" styleClass="modal_select" notInclude="1,2,3" emptyText="<%=Constant.EMPTY_SELECT %>" dicTypeCode="<%=DicConstants.YHRS0102%>"/>
						</label>
					</dd>
				</dl>
				<dl class='search-unit' >
					<dt class="search-unit-dt">状态：</dt>
					<dd class="search-unit-dd">
						<label>
							<dictionary:dicItemSelect id="orgStatus"  name="orgStatus" styleClass="modal_select" notInclude="1" emptyText="<%=Constant.EMPTY_SELECT %>" dicTypeCode="<%=DicConstants.YHRS0101%>"/>
						</label>
					</dd>
				</dl>
		...
		<div class='handle-btn-group'>
			...
			<div class="handle-btn clearfix" id="handel-button">
	        	...
	        	<button class="btn-delete btn-left-icon btn-default" button-click="revoke">撤销</button>
			</div>
			<!-- 列表内容展示-->
