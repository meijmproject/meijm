...
public class PbReviewInfoDTO {
	...
	private java.lang.Long reviewOid;        //业务库考核OID
	private java.lang.Long personOid;        //PersonOid
	private java.lang.String reviewTypeCode;        //考核类别
	private java.lang.String reviewTypeName;        //考核类别描述
	private java.util.Date reviewYear;        //考核年度
	private java.lang.String reviewYearStr;        //考核年度
	private java.lang.Long reviewResultCode;        //考核结论code
	private java.lang.String reviewResultDesc;        //考核结论描述
	private java.util.Date reviewDate;        //考核日期
	private java.lang.String reviewDateStr;        //考核日期
	private java.lang.String reviewUnitOid;        //考核时所在单位
	private java.lang.String reviewUnitName;        //考核时所在单位
	...
	public void setReviewYear(java.util.Date reviewYear){
		if (reviewYear != null) {
			...
			this.reviewYearStr = DateUtil.formatDate(reviewYear)
					.substring(0, 4);
		}
	}
	...
	public void setReviewDate(java.util.Date reviewDate){
		if(reviewDate!=null){
			...
			this.reviewDateStr = DateUtil.formatDate(reviewDate);
		}
	}
	...
	public java.lang.String getReviewYearStr() {
		return this.reviewYearStr;
	}

	public void setReviewYearStr(java.lang.String reviewYearStr) {
		if (reviewYear != null) {
			if (reviewYearStr != null) {
				this.reviewYearStr = reviewYearStr;
				this.reviewYear = DateUtil.parseDate(reviewYearStr + "-" + "01"
						+ "-" + "01");
			}
		}
	}

	public java.lang.String getReviewDateStr() {
		return reviewDateStr;
	}

	public void setReviewDateStr(java.lang.String reviewDateStr) {
		if(reviewDateStr!=null){
			this.reviewDateStr = reviewDateStr;
			this.reviewDate = DateUtil.parseDate(reviewDateStr);
		}
	}
