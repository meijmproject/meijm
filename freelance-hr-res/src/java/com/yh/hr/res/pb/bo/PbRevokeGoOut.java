...
/**
 * @description 普通外出销假基础表BO
 * @author wangx
 * @date 2017-05-20
 * @version 1.0
 *
 */
public class PbRevokeGoOut extends BaseBo {
	...
	public Long getPbGoOutOid() {
		return pbGoOutOid;
	}
	public void setPbGoOutOid(Long pbGoOutOid) {
		this.pbGoOutOid = pbGoOutOid;
	}
