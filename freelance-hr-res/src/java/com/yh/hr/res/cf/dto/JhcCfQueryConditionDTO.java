...
public class JhcCfQueryConditionDTO {

	private java.lang.Long queryConditionOid;        //主键ID
	private java.lang.String functionCode;        //功能码，标识是那个功能设置的条件
	private java.lang.String conditionName;        //条件显示名称
	private java.lang.String conditionCode;        //查询条件名称对应别名，如姓名-name；性别-sexCode
	private java.lang.String databaseField;        //数据库对应字段
	private java.lang.String conditionType;        //条件类型；1-输入型；2-日期型；3-下拉框选择型；4-字典弹出框型；
	private java.lang.String dicType;        //字典选项对应的字典类型码；如性别-YHRS0001
