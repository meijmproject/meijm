...
import com.yh.hr.res.pt.queryhelper.PtEducationInfoQueryHelper;
...
import com.yh.platform.core.util.WageUtilHelper;
 ...
 */
public class PtEducationInfoServiceImpl implements PtEducationInfoService
{
	...
	public List<PtEducationInfoDTO> listPtEducationInfoByBizPersonOid(Long bizPersonOid) throws ServiceException {
		...
		return PtEducationInfoQueryHelper.listPtEducationDTOByBizPersonOid(bizPersonOid);
	}
	...
	public int countPtEducationInfoByBizPersonOid(Long bizPersonOid)
		...
		return PtEducationInfoQueryHelper.countPtEducationDTOByBizPersonId(bizPersonOid);
	}
	...
	public static class  PtEducationInfoInnerService {
		...
		public static void synchroPtEducationInfo4PtPersonAttach(Long bizPersonOid) throws ServiceException {
			try {
				...
				List<PtEducationInfoDTO> ptInfoDTOs  =  PtEducationInfoQueryHelper.listPtEducationDTOByBizPersonOid(bizPersonOid);
		...
		private static void setFtTopEduLevelCode(PtPersonAttach ptPersonAttach,List<PtEducationInfoDTO> ptInfoDTOs) throws ServiceException {
			...
			if(ptEducationInfoDTO != null){
				...
				//更新所在院系
				ptPersonAttach.setFtAcademyName(ptEducationInfoDTO.getAcademyName());
			}
		}
		...
		private static void setFtTopDegreeCodeWithNull(PtPersonAttach ptPersonAttach) throws ServiceException {
			...
			//所在院系
			ptPersonAttach.setFtAcademyName(null);
		}
		...
		private static void setOjTopEduLevelCode(PtPersonAttach ptPersonAttach,List<PtEducationInfoDTO> ptInfoDTOs) throws ServiceException {
			...
			if(ptEducationInfoDTO != null){
				...
				//所在院系
				ptPersonAttach.setOjAcademyName(ptEducationInfoDTO.getAcademyName());
			}
		}
		...
		private static void setOjTopEduLevelCodeWithNull(PtPersonAttach ptPersonAttach) throws ServiceException {
			...
			//所在院系
			ptPersonAttach.setOjAcademyName(null);
		}
		
		
		//当找到最高学历学位时，清空其它学历信息集中的最高标识 
		private static void cleanOtherHighFlag(Long bizPersonOid,Long ptEducationOid,boolean flag) throws ServiceException {
			PtEducationInfoQueryHelper.updateIsHighFlag(bizPersonOid,ptEducationOid, flag);
		}
	...
	public void createWagePtEducationInfo(PtEducationInfoDTO ptEducationInfoDto)throws ServiceException {
		...
		Date graduateDate = ptEducationInfo.getGraduateDate();
		//根据人员id获的影响工资基础信息
		PtWageInfluenceDTO ptWageInfluenceDTO =  ptWageInfluenceService.getPtWageInfluenceDTOById(ptEducationInfo.getBizPersonOid());
		//设置起薪时间
		ptWageInfluenceDTO.setStartDateOfWage(WageUtilHelper.getNextMonthFirstDay(graduateDate));
