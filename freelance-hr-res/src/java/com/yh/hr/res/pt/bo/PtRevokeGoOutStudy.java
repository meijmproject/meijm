...
/**
 * @description 外出进修销假业务表BO
 * @author wangx
 * @date 2017-05-20
 * @version 1.0
 *
 */
public class PtRevokeGoOutStudy extends BaseBo {
	 ...
	 * 主键ID
	 */
	private Long ptRevokeGoOutStudyOid;
	/**
	 * 外出进修业务OID
	 */
	...
	public Long getPtRevokeGoOutStudyOid() {
		return ptRevokeGoOutStudyOid;
	}
	public void setPtRevokeGoOutStudyOid(Long ptRevokeGoOutStudyOid) {
		this.ptRevokeGoOutStudyOid = ptRevokeGoOutStudyOid;
	}
