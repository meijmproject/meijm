...
public class PtRetrieInfoDTO {
	
	private java.lang.Long bizPersonOid;
	private java.lang.String retrieTypeCode; //离退类别YHRS0057
	private java.util.Date retrieDate;  //离退日期
	private java.lang.String retrieReason;//提前退休原因YHRS0058
	private java.lang.String retireTreatmentLevelCode;//离退后享受待遇级别YHRS0015
	private java.lang.String retireTreatmentTypeCode; //离退后享受待遇类别YHRS0109
	private java.lang.Float retireFeeRatio;  //离退休费比例
	private java.lang.Float retireAllowanceRatio;//离退休补助比例
	...
	private java.lang.Float specialContributionRatio;//特殊贡献比例
	private java.lang.String specialContributionFlag;//特殊贡献标志YHRS0003
	private java.lang.Float returnedOverseasChiScale;//归侨加发比例
	private java.lang.String returnedOverseasFlag;//归国华侨标志YHRS0003
	private java.lang.String isNoChildForLife;//是否终身无子女YHRS0003
	private java.lang.String isTechingThirtyYears;//是否教龄满三十年YHRS0003
	private java.lang.String isPoliceThirtyYears;//是否公安干警满三十年YHRS0003
	private java.lang.String approvalType;//审批类型YHRS0060
	private java.lang.String approvalUnit;//审查部门
	private java.lang.String compliedClause;//符合条例YHRS0061
