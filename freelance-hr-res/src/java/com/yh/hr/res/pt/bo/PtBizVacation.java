...
public class PtBizVacation extends BaseBo {

	private static final long serialVersionUID = -794236900442393133L;
	
	private Long vacationOid;	//主键ID
	private Long bizPersonOid;	//人员ID
	private Long baseVacationOid;//基础表OID
	...
	public Long getBaseVacationOid() {
		return baseVacationOid;
	}
	public void setBaseVacationOid(Long baseVacationOid) {
		this.baseVacationOid = baseVacationOid;
	}
