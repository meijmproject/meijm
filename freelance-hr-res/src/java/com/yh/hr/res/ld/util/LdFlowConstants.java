package com.yh.hr.res.ld.util;

import java.util.HashMap;
import java.util.Map;

public class LdFlowConstants {
	...
	/**
	 * 资源类型-领导职数调整
	 * 1，领导职数调整，2:占用，3释放，4冻结，5解冻，6锁定，7解锁，99其它
	 */
	...
	{
		 resTypeNameMap.put(RES_TYPE_1, "领导职数调整");
