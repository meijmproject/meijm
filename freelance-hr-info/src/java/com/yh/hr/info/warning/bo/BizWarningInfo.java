 ...
 * 
 */
public class BizWarningInfo extends BaseBo implements java.io.Serializable
{
	...
	/**
	 * @param bizWarningInfoOid the bizWarningInfoOid to set
	 */
