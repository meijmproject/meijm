...
public class VerPbVacationInfoForm extends ValidatorForm{
	
	private static final long serialVersionUID = 3284952881870488028L;

	private Long vacationOid;	//主键ID
	private Long personOid;	//人员ID
	private String vacationType;//休假类型
	private Date startDate;	//休假开始时间
	private String startDateStr;	//休假开始时间
	private Date endDate;	//休假结束时间
	private String endDateStr;	//休假结束时间
