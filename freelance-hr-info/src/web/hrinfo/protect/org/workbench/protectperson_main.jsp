		...
		success : function(data) {
			...
			$.each(item,function(index) {
				...
				if(item[index].personOid==personOid){
					li+="<li class='name_checked' title='"+item[index].name+"'><a href='javascript:void(0);' class='nl-name-a' onclick=findPersonType(this,'"+personType+"','"+personId+"','"+isLock+"','"+isUnitLock+"')>"+item[index].name+"</a></li>";
