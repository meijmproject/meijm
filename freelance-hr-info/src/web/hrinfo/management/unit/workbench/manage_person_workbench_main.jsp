...
function expandNode(){
	$.ajax({
		...
		success : function(data) {
		    ...
		    //默认显示右侧工作台  
			$(".right-content").load("goToPersonManagePage.do?method=goToPersonWorkBench&functionCode=personManage&orgOid="+orgOid+"&organizationOid="+organizationOid);
		}
	});
}
...
{
	$(".right-content").load("goToPersonManagePage.do?method=goToPersonWorkBench&orgOid="+orgOid+"&functionCode=personManage");
}
function workUnitLocation(organizationOid)
{
	$(".right-content").load("goToPersonManagePage?method=goToPersonWorkBench&organizationOid="+organizationOid+"&functionCode=personManage");
}
</script>
</body>
</html>