...
<!--
 * @function    人员进入信息修改页面
 * @page name   hrinfo/ver/unit/comm/pbpersonin/pbPersonInUpdate.jsp
 * @author      cheny
 * @created     2017/03/20
 * @version     1.0
-->
...
<body>
<form id="pbPersonInForm" class="form-inline" action="updatePbPersonIn.do?method=update" method="post" onsubmit="return false">
  <div id="transaction_modal_box" class="transaction_modal_box">
    <div class="modal-dialog-container">
      <div class="md-title">人员进入信息&gt;修改<a href="#" class="md-close close-popdown"></a></div>
      <div class="md-error" style="display: none">
        <p>以下信息有误,请重新输入</p>
      </div>
      <div class="md-main-content">
        <input type="hidden" id="personInOid" name="personInOid" value="${pbPersonInForm.personInOid}" />
        <input type="hidden" id="personOid" name="personOid" value="${pbPersonInForm.personOid}" />
