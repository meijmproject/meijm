...
<!--
 * @function    合同信息新增页面
 * @page name   /hrinfo/ver/unit/comm/pbengagecontractinfo/verpb_pbengagecontractinfo_create.jsp
 * @author      liul
 * @created     2016/02/16
 * @version     1.0
-->
...
<body>
	...
	<form id="engageContractInfoForm" class="form-inline" action="createPbEngageContractInfo.do?method=create" method="post" onsubmit="return false">
		<div id="transaction_modal_box" class="transaction_modal_box">
			<div class="modal-dialog-container">
				<div class="md-title">
					合同信息&gt;新增 <a href="#" class="md-close close-popdown"></a>
				</div>
...
<%-- 					<input type="hidden" name="unitPhone" value="${engageContractInfoForm.unitPhone }" /> --%>
					...
					<div class="md-units md-three-column clearfix">
						...
						<dl class="updown-dl">
							...
							<dd>
								<label><dictionary:dicItemSelect name="changeType" styleClass="modal_select" emptyText="<%=Constant.EMPTY_SELECT %>" dicTypeCode="<%=DicConstants.YHRS0115%>" selected="${engageContractInfoForm.changeType}" />
								</label>
							</dd>
						</dl>
						<dl class="updown-dl">
						...
						<dl class="updown-dl">
							...
							<dd>
								<label><dictionary:dicItemSelect name="status" id="status" styleClass="modal_select" emptyText="<%=Constant.EMPTY_SELECT %>" dicTypeCode="<%=DicConstants.YHRS0116%>" selected="${engageContractInfoForm.status}" />
								</label>
							</dd>
						</dl>
						<dl class="updown-dl">
						...
						<dl class="updown-dl">
							...
							<dd>
								...
								<input type="text" name="unitMaster" id="unitMaster" value="<bean:write name="engageContractInfoForm" property="unitMaster" />" /> </label>
							</dd>
						</dl>
						<dl class="updown-dl">
							<dt>用人单位地址：</dt>
							<dd>
								...
								<input type="text" name="unitAddress" id="unitAddress" value="<bean:write name="engageContractInfoForm" property="unitAddress" />" /> </label>
							</dd>
						</dl>
						<dl class="updown-dl">
							<dt>用人单位联系电话：</dt>
							<dd>
								...
								<input type="text" name="unitPhone" id="unitPhone" value="<bean:write name="engageContractInfoForm" property="unitPhone" />" /> </label>
							</dd>
						</dl>
						<dl class="updown-dl">
							<dt>其他事项：</dt>
