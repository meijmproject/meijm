...
<!--
* @page name  /hrinfo/ver/unit/comm/pbyngwemployinfo/verpb_pbyngwemployinfo_create.jsp
* @function   院内岗位聘任信息新增页面
* @author     liul
* @created    2017-02-15
* @version    1.0
-->
        ...
        $(document).ready(function(){
        	 $('#hisPositionName').click(function(){
        	        if($('#hisWorkTypeName').val()==null || $('#hisWorkTypeName').val() ==""){
        	        	...
        	        	selectWorkTop.init($('#hisPositionName'),hisWorkType,hisPositionType,null,true); 
            	    }
        	    })
        		//根据工作类别的选,加载岗位类别的下拉框
...
<body id="createBody">
<form id="ynGwEmployInfoForm" class="form-inline" action="createPbYnGwEmployInfo.do?method=create" method="post" onsubmit="return false">
<div id="transaction_modal_box" class="transaction_modal_box">
    <div class="modal-dialog-container">
        <div class="md-title"> 院内岗位聘任信息&gt;新增
        	...
        	<div class="md-units md-three-column clearfix">
                <dl class="updown-dl">
                   <dt><b class="Required">* </b>岗位聘任状态：</dt>
                    <dd>
                        <label>
                            <dictionary:dicItemSelect styleClass="modal_select" id="hisPositionStatus"  dicTypeCode="<%=DicConstants.YHRS0026%>" selected="001" onchange="positionStatusOnchange(this.value)" name="hisPositionStatus"  emptyText="<%=Constant.EMPTY_SELECT %>"/>
                        </label>
                    </dd>
                     </dl>
                     <dl class="updown-dl">
              ...
              <dl class="updown-dl">
	                    ...
	                    <dd>
	                     <label>
	                        <input type="text" class="modal_iput" name="appointProfTitleName" readonly="readonly"  id="appointProfTitleCode" value='<dictionary:viewDicItemName dicTypeCode="YHRS0117" dicItemCode="${pbYnGwEmployInfoForm.appointProfTitleName}" />' onclick="min_Dic.min_Dictionary(this,'YHRS0117',true,null,null,null,['bottom','left']) " notInclude=""/>
