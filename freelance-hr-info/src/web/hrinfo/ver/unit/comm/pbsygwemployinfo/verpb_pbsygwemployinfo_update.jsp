...
<!--
* @page name  /hrinfo/ver/unit/comm/pbsygwemployinfo/verpb_pbsygwemployinfo_update.jsp
...
<form id="syGwEmployInfoForm" class="form-inline" action="updatePbSyGwEmployInfo.do?method=update" method="post" onsubmit="return false">
<div id="transaction_modal_box" class="transaction_modal_box">
    <div class="modal-dialog-container">
        ...
        <div class="md-main-content">
	      	<input type="hidden" id="syGwEmployOid" name="syGwEmployOid" value="${pbSyGwEmployInfoForm.syGwEmployOid}" />
            ...
            <input type="hidden" id="currentUnitName" name="currentUnitName" value="${currentUnitName}"/>
            <input type="hidden" id="currentUnitOid" name="currentUnitOid" value="${currentUnitOid}"/>
        	...
        	<div class="md-units md-three-column clearfix">
                <dl class="updown-dl">
                    ...
                    <dd>
                        <label>
                            <dictionary:dicItemSelect styleClass="modal_select" id="positioningStatus" onchange="positionStatusOnchange(this.value)" dicTypeCode="<%=DicConstants.YHRS0026%>" selected="${pbSyGwEmployInfoForm.positioningStatus}" name="positioningStatus"  emptyText="--请选择--"/>
                        </label>
                    </dd>
                     </dl>
                     <dl class="updown-dl">
                    ...
                    <dd>
                        <label title="<bean:write name="pbSyGwEmployInfoForm" property="dutyUnitName" />">
                            <div id="dutyUnitNameId" style="height:100%" >
                            	<input type="text" name="dutyUnitName" readonly="readonly" id="dutyUnitName" value="${pbSyGwEmployInfoForm.dutyUnitName}"/>
                                <input type="hidden" name="dutyUnitName" id="dutyUnitName" value="${pbSyGwEmployInfoForm.dutyUnitName}"/>
                    ...
                    <dd>
                    <label>
                         <input type="text" class="modal_iput" name="positionLevelName" readonly="readonly"  id="positionLevel" value='<dictionary:viewDicItemName dicTypeCode="<%=DicConstants.YHRS0023%>" dicItemCode="${pbSyGwEmployInfoForm.positionLevel}" />' onclick="min_Dic.min_Dictionary(this,'<%=DicConstants.YHRS0023%>','Y','')" />
                ...
                <dl class="updown-remark">
                	<dt>备注：</dt>
							...
							<textarea id="remark" name="remark" rows="3" maxlength="1000">${pbSyGwEmployInfoForm.remark}</textarea>
							</label></dd>
                </dl>
            </div>
          ...
          <div class="modal-footer">
		    	<button id="saveSyGwEmployInfo" type="button" class="btn btn-primary">保　存</button>
