...
<!--
 * @function    人员离开信息修改页面
 * @page name   hrinfo/ver/unit/comm/pbpersonin/pbPersonOutUpdate.jsp
 * @author      liupt
 * @created     2017/04/7
 * @version     1.0
-->
...
<body>
<html:form styleId="pbPersonOutForm" styleClass="form-inline" action="updatePbPersonOut.do?method=update" method="post">
<div id="transaction_modal_box" class="transaction_modal_box">
    <div class="modal-dialog-container">
      <div class="md-title">人员离开信息&gt;修改<a href="#" class="md-close close-popdown"></a></div>
      <div class="md-error" style="display: none">
        <p>以下信息有误,请重新输入</p>
      </div>
      <div class="md-main-content">
      <input type="hidden" id="personOutOid" name="personOutOid" value="${pbPersonOutForm.personOutOid}" />
      <input type="hidden" id="personOid" name="personOid" value="${pbPersonOutForm.personOid}" />
    ...
    <dl class="updown-dl">
		...
		<dl class="updown-remark">
			<dt>备注：</dt>
			<dd>
				<label><textarea id="remark" name="remark" rows="2" maxlength="1000">${pbPersonOutForm.remark}</textarea>
				</label>
			</dd>
			</dl>
        </div>
